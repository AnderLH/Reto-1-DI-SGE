...
@section('content')
<div class="container">
    <h1 class="text-center" id="depart-styles">Lista de Prioridades</h1>
    <div class="row">
    <ul class="list-group">
        @auth
        ...
        <li class="list-group-item">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h5 class="mb-0">
                        <a href="{{ route('priorities.show', $priority) }}" id="incident-title">{{ $priority->name }}</a>
                    </h5>
                    ...
                    <ul class="list-group">
                        ...
                        @endif
                        @empty
                        <p id="incident-title">No hay incidencias disponibles.</p> <!-- Agregar este mensaje si no hay incidencias asociadas a la prioridad -->
                        @endforelse
                    </ul>
                </div>
                @auth
        ...
        @empty
        <li class="list-group-item" id="incident-title">No hay prioridades disponibles.</li>
        @endforelse
    </ul>
</div>
@endsection

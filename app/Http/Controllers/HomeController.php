...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('home', ['incidents' => $incidents,'statuses' => $statuses]);
    }
    ...
    public function show(Incident $incident)
    {
        ...
        return view('home', ['incident' => $incident]);
    }
    ...
    public function edit(Incident $incident)
    {
        ...
        $priorities  = Priority::orderBy('created_at')->get();
        $categories  = Category::orderBy('created_at')->get();
        return view('home', ['incident' => $incident, 'statuses' => $statuses, 'priorities' => $priorities, 'categories' => $categories]);
    }
